...
namespace MyosotisFW::System::Render
{
	...
	public:
		GridRenderPass(const RenderDevice_ptr& device, const RenderResources_ptr& resources, const RenderSwapchain_ptr& swapchain);
		~GridRenderPass();
	...
	TYPEDEF_SHARED_PTR_ARGS(GridRenderPass);
}