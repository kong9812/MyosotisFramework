...
{
	GizmoRenderPass::GizmoRenderPass(const RenderDevice_ptr& device, const RenderResources_ptr& resources, const RenderSwapchain_ptr& swapchain) :
	...
	void GizmoRenderPass::Initialize()
	{
		// attachments
	...
	void GizmoRenderPass::EndRender(const VkCommandBuffer& commandBuffer)
	{
