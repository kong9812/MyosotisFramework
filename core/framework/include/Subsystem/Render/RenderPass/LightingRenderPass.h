...
namespace MyosotisFW::System::Render
{
	...
	class LightingRenderPass : public RenderPassBase
	{
	public:
	...
	public:
		LightingRenderPass(const RenderDevice_ptr& device, const RenderResources_ptr& resources, const RenderSwapchain_ptr& swapchain);
		~LightingRenderPass();
	...
	TYPEDEF_SHARED_PTR_ARGS(LightingRenderPass);
}