...
namespace MyosotisFW::System::Render
{
	...
	class PostProcessRenderPass : public RenderPassBase
	{
	public:
	...
	public:
		PostProcessRenderPass(const RenderDevice_ptr& device, const RenderResources_ptr& resources, const RenderSwapchain_ptr& swapchain);
	...
	TYPEDEF_SHARED_PTR_ARGS(PostProcessRenderPass);
}