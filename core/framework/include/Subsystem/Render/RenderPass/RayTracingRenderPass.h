...
namespace MyosotisFW::System::Render
{
	...
	class RayTracingRenderPass : public RenderPassBase
	{
	public:
		...
		{
			RayTracingRenderTarget,
			COUNT
		};

	public:
		RayTracingRenderPass(const RenderDevice_ptr& device, const RenderResources_ptr& resources, const RenderSwapchain_ptr& swapchain);
	...
	TYPEDEF_SHARED_PTR_ARGS(RayTracingRenderPass);
}