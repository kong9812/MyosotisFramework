...
namespace MyosotisFW::System::Render
{
	...
	class TerrainRenderPass : public RenderPassBase
	{
	public:
	...
	public:
		TerrainRenderPass(const RenderDevice_ptr& device, const RenderResources_ptr& resources, const RenderSwapchain_ptr& swapchain);
		~TerrainRenderPass();
	...
	TYPEDEF_SHARED_PTR_ARGS(TerrainRenderPass);
}