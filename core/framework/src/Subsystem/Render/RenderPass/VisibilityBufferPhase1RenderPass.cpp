...
{
	VisibilityBufferPhase1RenderPass::VisibilityBufferPhase1RenderPass(const RenderDevice_ptr& device, const RenderResources_ptr& resources, const RenderSwapchain_ptr& swapchain) :
		RenderPassBase(device, resources, swapchain->GetWidth(), swapchain->GetHeight()) {
	}

	VisibilityBufferPhase1RenderPass::~VisibilityBufferPhase1RenderPass()
	{
	...
	void VisibilityBufferPhase1RenderPass::Initialize()
	{
		// attachments
	...
	void VisibilityBufferPhase1RenderPass::BeginRender(const VkCommandBuffer& commandBuffer, const uint32_t frameIndex)
	{
	...
	void VisibilityBufferPhase1RenderPass::EndRender(const VkCommandBuffer& commandBuffer)
	{
		vkCmdEndRenderPass(commandBuffer);
	}

	void VisibilityBufferPhase1RenderPass::createFrameBuffers()
	{
