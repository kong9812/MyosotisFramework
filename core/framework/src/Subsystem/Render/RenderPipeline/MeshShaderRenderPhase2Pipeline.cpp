...
{
	MeshShaderRenderPhase2Pipeline::~MeshShaderRenderPhase2Pipeline()
	{
	...
	void MeshShaderRenderPhase2Pipeline::Initialize(const RenderResources_ptr& resources, const VkRenderPass& renderPass)
	{
	...
	void MeshShaderRenderPhase2Pipeline::BindCommandBuffer(const VkCommandBuffer& commandBuffer, const uint32_t meshCount)
	{
		{// Phase2Render
	...
	void MeshShaderRenderPhase2Pipeline::prepareRenderPipeline(const RenderResources_ptr& resources, const VkRenderPass& renderPass)
	{
		// push constant
