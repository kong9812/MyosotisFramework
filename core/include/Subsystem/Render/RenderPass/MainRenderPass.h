...
namespace MyosotisFW::System::Render
{
	...
	public:
		MainRenderPass(const RenderDevice_ptr& device, const RenderResources_ptr& resources, const RenderSwapchain_ptr& swapchain, const uint32_t& width, const uint32_t& height);
		~MainRenderPass();
