...
{
	DeferredRenderPipeline::DeferredRenderPipeline(RenderDevice_ptr device, RenderResources_ptr resources, VkRenderPass renderPass)
	{
		m_device = device;
	...
	void DeferredRenderPipeline::prepareRenderPipeline(RenderResources_ptr resources, VkRenderPass renderPass)
	{
		// [pipeline]layout
