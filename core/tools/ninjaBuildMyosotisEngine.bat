...
cmake --build ../../bin/ninja_msvc/release --target MyosotisEngine --config Release --parallel
cmake --build ../../bin/ninja_msvc/debug --target MyosotisEngine --config Debug --parallel
